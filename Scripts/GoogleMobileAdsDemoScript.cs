...
public class GoogleMobileAdsDemoScript : MonoBehaviour
{
...
#if UNITY_ANDROID
        string appId = "ca-app-pub-1152051333116465~6507992433";
#elif UNITY_IPHONE
    ...
    private void RequestInterstitial()
    {
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-1152051333116465/9137476468";         //first ad ciclo (main)
#elif UNITY_IPHONE
